...
public class SmokeTabletTest extends BaseTest {
    ...
    public void swipeIntroductionPageTest() {
        ...
        int result = 0;
        for (int i = 0; i < 3; i++) {
            String title = getElement(introductionPage.skipButton).getText();
            if (title.equals("Skip")) {
                result = result + 1;
            }
            waitManager.waitElementToBeClickable(40, getElement(introductionPage.skipButton));
    ...
    public void swipeIntroductionLastPageTest() {
        ...
        userActionsManager.swipeToLeft();
        waitManager.waitElementToBeClickable(60, getElement(homePageTab.settingsButton));
    ...
    public void intoductionPageButtonsTest() {
        for (int i = 0; i < 4; i++) {
            ...
            waitManager.waitElementToBeClickable(10, getElement(introductionPage.skipButton));
    ...
    public void searchFieldTitleTest() {
        clickOnElement(homePageTab.yourProductSearchField);
    ...
    public void searchFieldEditQueryTest() {
        ...
        waitManager.waitElementToBeClickable(10, getElement(searchPageTab.clearQueryButton));
        clickOnElement(searchPageTab.clearQueryButton);
        waitManager.waitElementToBeClickable(10, getElement(searchPageTab.viewAllProductButton));
        String result = getElement(searchPageTab.viewAllProductButton).getText();
    ...
    public void searchFieldCancelTest() {
        clickOnElement(searchPageTab.cancelSearchButton);
        waitManager.waitElementToBeClickable(10, getElement(homePageTab.settingsButton));
    }
    ...
    public void openDetailsPageOfAnyProduct() throws InterruptedException {
        ...
        waitManager.waitElementToBeClickable(10, getElement(homePageTab.settingsButton));
        clickOnElement(homePageTab.yourProductSearchField);
        clickOnElement(searchPageTab.viewAllProductButton);
        waitManager.waitElementToBeVisible(20, searchPageTab.getSearchResultsQuantity());
        ...
        waitManager.waitElementToBeClickable(120, modelOverviewPage.getGetInstructionsButton());
    ...
    public void partsListPageGetInstructionsTest() {
        ...
        waitManager.waitElementToBeClickable(300, modelOverviewPage.getStartAssemblyButton());
        modelOverviewPage.openPartsListPage();
        boolean result = false;
    ...
    public void myStuffTest() {
        ...
        modelOverviewPage.getBackButton().click();
        waitManager.waitElementToBeClickable(10, getElement(searchPageTab.cancelSearchButton));
        clickOnElement(searchPageTab.cancelSearchButton);
        waitManager.waitElementToBeClickable(10, getElement(homePageTab.settingsButton));
        homePageTab.getMyStuffButton().click();
    ...
    public void signInButtonDisabledTest(String email, String password) {
        ...
        DriverManager.getDriver().navigate().back();
        waitManager.waitElementToBeVisible(10, signInMenu.getSignInButton());
    ...
    @Test(testName = "TC BILTAPPTST-303_3", enabled = true, priority = 53, description = "Close Sign Up")
    public void closeSignUpInTest() {
        signUpMenu.getMenuCloseButton().click();
        signInMenu.getMenuCloseButton().click();
        waitManager.waitElementToBeClickable(10, getElement(homePageTab.settingsButton));
    }
